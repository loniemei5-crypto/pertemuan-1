...
if jumlah_batu_bata == 500 and jumlah_semen == 5:
    jenis_paket = "paket hemat"
    diskon= 0.15
elif jumlah_batu_bata == 2000 and jumlah_semen == 16:
    jenis_paket = "paket ultra mantap (30%)"
    keterangan_diskon = 0.30
else:
    jenis_paket = "anda tidak mendapatkan diskon"
    keterangan_diskon = 0

keterangan_diskon = total_biaya_awal*keterangan_diskon
total_setelah_diskon = total_biaya_awal-keterangan_diskon
...
print("-" * 44)
print(f"Total Biaya Awal{'':<27}: {(total_biaya_awal)}")
print(f"Paket Yang Didapat{'':<25}: {jenis_paket}")
print(f"Jumlah Diskon{'':<30}: {keterangan_diskon}")
print("-" * 44)  
print(f"TOTAL BIAYA AKHIR:{(total_setelah_diskon)}")
print("=" * 44)